  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/" element={<Recording data={fakeData} />} />
        <Route path="/:memoryId" element={<Recording data={fakeData} />} />
        <Route
          path="/memories"
